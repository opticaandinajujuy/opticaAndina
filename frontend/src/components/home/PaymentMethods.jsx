...
function PaymentMethods() {
  return (
    <div className="flex flex-col gap-3 sm:flex-row">
      <div className="flex flex-1 items-center gap-3 rounded-xl border border-sage-100 bg-white px-4 py-3.5">
      ...
      <div className="flex flex-1 items-center gap-3 rounded-xl border border-mustard-200 bg-mustard-50 px-4 py-3.5">
